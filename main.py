    ...
    await update.message.reply_text(
        ...
        reply_markup=ReplyKeyboardMarkup.from_button(
            KeyboardButton(
                ...
                web_app=WebAppInfo(url="https://peramein-golezafron.github.io/test/"),
            )
        ),
    )
...
def main() -> None:
    ...
    application = Application.builder().token("7053223834:AAFK5Zdd0-FFBiAEJmx7YOcjT_w_peoqF-Q").build()
